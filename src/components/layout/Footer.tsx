        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              مركز متخصص في فحص المركبات بأحدث التقنيات وأعلى المعايير العالمية
            </p>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">
                  شارع المدينة المنورة، عمان، الأردن
                </span>
              </li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              اشترك في نشرتنا البريدية للحصول على آخر العروض والنصائح
            </p>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} MotorLab. جميع الحقوق محفوظة
            </p>
            <div className="flex space-x-4 rtl:space-x-reverse">
              <Link
                href="/privacy"
